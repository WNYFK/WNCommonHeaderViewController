#
#  Be sure to run `pod spec lint WNCommonHeaderViewController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "WNYFK"
  # s.authors            = { "WNYFK" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/WNYFK"
